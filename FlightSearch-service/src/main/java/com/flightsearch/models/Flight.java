...
public class Flight {
	@Id
	private int id;
	@NotEmpty(message="departure_location should not be null")
	private String departure_location;
	@NotEmpty(message="arrival_location should not be null")
	private String arrival_location;
	@NotEmpty(message="airline name should not be null")
	private String airline;
	
	private int flight_number;
	@NotEmpty(message="departure_time should not be null")
	private String departure_time;
	@NotEmpty(message="arrival_time should not be null")
